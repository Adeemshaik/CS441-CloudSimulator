package com.ADCS441.tablebuilder;
...
public class CustomTableBuilder extends CloudletsTableBuilder {
    ...
    protected void createTableColumns() {
        ...
        addColumnDataFunction(getTable().addColumn("DataCenter", ID), task -> task.getVm().getHost().getDatacenter().getId());
        ...
        addColumnDataFunction(getTable().addColumn("CloudletLength", "MI"), Cloudlet::getLength);
